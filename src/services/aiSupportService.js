...
//                             // ✅ TEXT EXTRACTION - Preserves actual content
//                             let textContent = '';
...
//                             // ✅ METHOD 5: CLEAN TEXT EXTRACTOR - Only extracts text without code symbols
...
//                             //         // Use clean text if it's better than what we have
...
//                             // ✅ METHOD 5: CLEAN TEXT EXTRACTOR - Only extracts text without code symbols
//                             // ✅ METHOD 5: CLEAN TEXT EXTRACTOR - Skip for .js files
//                             if (!file.endsWith('.js')) {
//                                 const cleanTextMatches = content.match(/>([^{}<>{})]{15,})</g) || [];
//                                 if (cleanTextMatches.length > 0) {
//                                     const cleanText = cleanTextMatches
